...
namespace BITSBusTimesDataAPI.Controllers
{
    public class BITSBusTimesController : ApiController
    {
        ...
        static BITSBusTimesController()
        {
            ...
            mockData.Add(0, new BITSBusTime { OriginID = 5555, DestinationID = 8888, BusID = 848, ArrivalTime = 12, TravelTime = 30, AvailableSeats = 11 });
            mockData.Add(1, new BITSBusTime { OriginID = 5555, DestinationID = 8888, BusID = 975, ArrivalTime = 5, TravelTime = 35, AvailableSeats = 6 });
            mockData.Add(2, new BITSBusTime { OriginID = 7777, DestinationID = 2222, BusID = 848, ArrivalTime = 3, TravelTime = 70, AvailableSeats = 10 });
        }
    ...
    //    }
        ...
        public void Post(BITSBusTime BusTime)
        {
            ...
            int ID = mockData.Count > 0 ? mockData.Keys.Max() + 1 : 1;
            mockData.Add(ID, BusTime);
        }
